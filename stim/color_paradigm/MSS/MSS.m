...
experiment_code='cps';  % this should be a short (2-3 letter) code for the experiment
...
experiment_notes='In this experiment, we are looking at color perception.';
...
%DrawFormattedText_new(w,'The "Who is more?" study is about to begin!','center','center', white, default_wrap, 0, 0);
DrawFormattedText(w,'Index finger = Yes, Middle finger = No.','center','center', white, default_wrap);
Screen('Flip',w);
