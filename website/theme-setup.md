...
title: Theme Setup
description: "Instructions on how to install and customize the modern Jekyll theme neurd."
...
<div markdown="0"><a href="https://github.com/wem3/freshMRI/archive/master.zip" class="btn">Download the Theme</a></div>
...
To utilize this "feature" just add the following YAML to a post's front matter. ([View demo](http://wem3.github.io/freshMRI/background-image/))
...
image:
  ...
  creditlink: http://wem3.github.io #url to their site or licensing
{% endhighlight %}
